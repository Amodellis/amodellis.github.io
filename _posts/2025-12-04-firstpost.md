...
tags: vision innovation AI transport-futures research
...
Recently, a thought-provoking post from [Seb Krier](https://x.com/sebkrier/status/1994796202760528113) caught my attention, highlighting the rise of **multi-agent systems**. The future will not be “one clever model for everyone”, but ecosystems of specialised agents modelling cooperation, competition, social dynamics, and spatial interactions.  
...
- queueing and matching systems  
- platform-level optimisation rules  
...
This is why we have introduced a new service area — [AI-Enabled Transport Research]({{ "/projects/service_research/" | relative_url }}) — as part of our long-term strategy. It sits alongside our core services in VDM, PT modelling, T&R forecasting, data analytics and choice modelling.
